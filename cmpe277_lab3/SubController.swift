...
class SubController: UIViewController ,KeyboardDelegate{
    var result = 0
    var n1 = 0
    var n2 = 0
    var qNumber = 0
    ...
    func showCorrect(){
        ...
        let toastLabel = UILabel(frame: CGRect(x: self.view.frame.size.width/2 - 100, y: self.view.frame.size.height/2 - y_offset, width:200, height: 35))
